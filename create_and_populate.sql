...
('Chadwick Jones', 'You met Chadwick back in high school, where he used to be backup quarterback for the football team and made a habit of stealing your lunch money. He has calmed down a bit since then and is occasionally good company to you. These days, he spends most of his time either investing in niche cryptocurrencies or working on his personal development podcast called "Grind, Conquer, Repeat: How to pick up women, crush betas, and dominate the financial world". You always thought this was a silly and convoluted title, but he insists it is catchy.', 'chadwick.png');
...
INSERT INTO characters (name, description, image) VALUES
('Rex "The Flex" Thompson', 'Rex is basically a protein shake in the shape of a man. He lives by three rules: Lift heavy, eat big, and never skip arm day. His wardrobe consists exclusively of gym tanks, and his biceps have their own gravitational pull. He speaks almost entirely in gym metaphors, referring to life''s challenges as "mental PRs" and bad days as "rest days for the soul." Despite his meat-head persona, he''s surprisingly wholesome — his ultimate dream isn''t just to be swole, but to help others be swole too. If you need a spot at the gym or an overenthusiastic pep talk, Rex is your guy. Just don''t ask him to stop flexing in every reflective surface.', 'rex.png');
